...
if [ "$INPUT_PASS" = "" ]
then
  sh -c "scp -i $SSHPATH/deploy_key -o StrictHostKeyChecking=no -p $INPUT_PORT /github/workspace/.docker-compose.deploy ${INPUT_USER}@${INPUT_HOST}:/home/ubuntu/test123.yml"
